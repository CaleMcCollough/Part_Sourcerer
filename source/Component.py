...
# @date         01/15/2015
# @brief        This file contains the DesignComponent class for Metascrapper
# @description  
#
# Metadata Fields
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Metadata fileds in Metascrapper are stored in a dictionary of 3 strings.
...
# -----------------------------------------------------------------------------------------------------------------------------
# In order to minimize the number of metadata fields, Metascrapper minimizes the number of fields by only displaying fields that are 
