...
# @date         01/15/2015
# @brief        This file contains the DigiKeyScrapper class for Metascrapper
# @description  DigiKeyScrapper is an app that assists in sourcing electronics products from parts suppliers.
# 
...
from ComponentScrapper import ComponentScrapper

class DigiKeyScrapper(ComponentScrapper):
    #__metaclass__ = ComponentScrapper
    
    def __init__(self, projectDirectory):
        ComponentScrapper.__init__(self, projectDirectory)
    ...
    class UnitTest():
        ...
        def testFromURLList():
            ...
            for url in testURLList:
                DigiKeyScrapper.testFromURL (url)
        ...
        def testFromURL(url):
            ...
            #Scrapper.saveDataToFile(DigiKeyScrapper.loadContentFromURL(url), 'DigiKeyTestFiles/DigiKeyOnlineTest.html')
        ...
        # @brief    function that runs diagonistics on the DigiKeyScrapper class
        @staticmethod
        def runUnitTest():
            os.system('cls')
            print 'Running DigiKeyScrapper diagnostics...\n'
            
            #DigiKeyScrapper.UnitTest.testFromFile()
            DigiKeyScrapper.UnitTest.testFromURL('http://www.digikey.com/product-detail/en/0879180001/WM2066-ND/1643335')
            #DigiKeyScrapper.UnitTest.testFromURLList ()
            
            print '\nFinished running DigiKeyScrapper diagnostics.\n'

DigiKeyScrapper.UnitTest.runUnitTest()