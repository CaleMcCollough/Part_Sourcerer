...
# @date         01/15/2015
# @brief        This file contains the EDASourcerer class for EDA-Tools
# @description  EDASourcerer is an app that assists in sourcing electronics components from parts suppliers.
# 
...
class EDASourcerer(HTMLParser):
    ...
    def loadFromURL(self, supplyCode, delineator, url):
        htmlDoc = EDASourcerer.loadContentFromURL(url)
        self.loadFromHTML(supplyCode, delineator, htmlDoc, url)
    ...
    def testFromURL(url):
        ...
        #EDASourcerer.saveDataToFile(EDASourcerer.loadContentFromURL(url), 'DigiKeyTestFiles/DigiKeyOnlineTest.html')
    ...
    # @brief    function that runs diagonistics on the EDASourcerer class
    @staticmethod
    def runDiagnostics():
        os.system('cls')
        print 'Running EDASourcerer tests...\n'
        
        #EDASourcerer.testFromFile()
        EDASourcerer.testFromURL('http://www.digikey.com/product-detail/en/0879180001/WM2066-ND/1643335')
        #EDASourcerer.testFromURLList ()
        
        print '\nDone runningEDASourcerer tests.\n'

EDASourcerer.runDiagnostics()
